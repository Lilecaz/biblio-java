...
public class BookTest {
    ...
    //     // Pas nécessaire dans ce cas, car les mocks ne nécessitent pas de fermeture
    // }
    ...
    public void testMultipleBooksAdditionAndVerification() throws SQLException {
        ...
        when(dbManager.ajouterLivre(livre1)).thenReturn(true);
        ...
        when(dbManager.ajouterLivre(livre2)).thenReturn(true);
        ...
        when(dbManager.getLivres()).thenReturn(livresSimules);
    ...
    public void testIncorrectBookDetails() throws SQLException {
        // Configurer le comportement du mock pour ajouter un livre avec des détails incorrects
